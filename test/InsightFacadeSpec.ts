/**
 * Created by Raghav on 2017-01-17.
 */
...
describe("InsightFacadeSpec", function () {
    ...
    it("test query with no dataset", function (done) {
        ...
        insightFacade.performQuery(simpleQuery).then(function (value: InsightResponse) {
    ...
    it.only("Courses: test courses.zip addDataset, ResponseCode 204", function (done) {
        this.timeout(30000);
        insightFacade.addDataset("courses", readZip("courses.zip")).then(function (value: InsightResponse) {
            console.log(value.code, value.body);
            sanityCheck(value);
    ...
    it("Wrong ID rooms: test addDataset with wrong id, ResponseCode 400", function (done) {
        this.timeout(30000);
        insightFacade.addDataset("courses", readZip("rooms.zip")).then(function (value: InsightResponse) {
            expect.fail();
            done();
        }).catch(function (err) {
            console.log("Error: ", err);
    ...
    it("Wrong ID courses: test addDataset with wrong id, ResponseCode 400", function (done) {
        this.timeout(30000);
        insightFacade.addDataset("rooms", readZip("courses.zip")).then(function (value: InsightResponse) {
            expect.fail();
            done();
        }).catch(function (err) {
            console.log("Error: ", err);
    ...
    it.only("Rooms PerformQuery: test id being new, ResponseCode 204", function (done) {
        this.timeout(30000);
        insightFacade.addDataset("rooms", readZip("rooms.zip")).then(function (value: InsightResponse) {
            console.log(value.code, value.body);
            sanityCheck(value);
            expect(value.code).to.equal(204);
            done();
    ...
    it.only("Rooms: test id already existing, ResponseCode 201", function (done) {
        this.timeout(10000);
        insightFacade.addDataset("rooms", readZip("rooms.zip")).then(function (value: InsightResponse) {
            console.log(value.code, value.body);
            sanityCheck(value);
    ...
    it("Get All Courses Data", function (done) {
        ...
        insightFacade.performQuery(testQuery).then(function (value: InsightResponse) {
            //console.log(value.code, value.body);
    ...
    it(
        "Complex query with OR, AND, NOT, IS, GT, EQ", function (done) {
        let testQuery = {
            "WHERE": {
                "OR": [
                    {
    ...
    it("testQuery, example includes order", function (done) {
        ...
        insightFacade.performQuery(testQuery1).then(function (value: InsightResponse) {
            console.log(value.code, value.body);
            expect(value.code).to.equal(200);
            done();
        }).catch(function (err) {
    ...
    it.only("testQuery with invalid column name keys", function (done) {
        let testQuery = {"WHERE":{"AND":[{"OR":[{"IS":{"rooms_shortname":"ESB"}}]}]},"OPTIONS":{"COLUMNS":["rooms_name","rooms_lat","rooms_lon","rooms_seats"],"ORDER":"rooms_seats","FORM":"TABLE"}};
    ...
    it("test getlatlon (valid)", function (done) {
        insightFacade.getLatLon("6245%20Agronomy%20Road%20V6T%201Z4").then(function (value: any) {
            expect(value.lat).to.equal(49.26125);
            expect(value.lon).to.equal(-123.24807);
    ...
    it("test getlatlon (invalid)", function (done) {
        insightFacade.getLatLon("6245%20Agronomy%20Road%20V6T%201Z").then(function (value: any) {
            expect.fail();
            ...
            Log.error(err.error);
            console.log("in fail");
            expect(err.error).to.equal("failed response");
            done();
        });
    });

    it("test getlatlon with spaces instead of %20 (valid)", function (done) {
        insightFacade.getLatLon("6245 Agronomy Road V6T 1Z4").then(function (value: any) {
            expect(value.lat).to.equal(49.26125);
            expect(value.lon).to.equal(-123.24807);
            console.log(value.lat);
            console.log(value.lon);
    ...
    it("test getlatlon with spaces instead of %20 (invalid)", function (done) {
        insightFacade.getLatLon("6245 Agronomy Road V6T 1Z").then(function (value: any) {
            expect.fail();
            console.log("should not be here");
            done();
        }).catch(function (err) {
    ...
    it("TESTS 3", function (done) {
        ...
        insightFacade.performQuery(testQuery).then(function (value: InsightResponse) {
            ...
            console.log(value.code);
            //console.log(value.body);
            expect(value.body).to.deep.equal({"render":"TABLE","result":[{"rooms_shortname":"OSBO","maxSeats":442},{"rooms_shortname":"HEBB","maxSeats":375},{"rooms_shortname":"LSC","maxSeats":350}]})
            done();
        }).catch(function (err) {
            console.log(err.code, err.body);
            expect.fail();
    ...
    // TODO: fix test for multiple APPLY
    ...
    // TODO: make GROUP supported in implementation
    ...
    it("test Query B", function (done) {
        ...
        insightFacade.performQuery(testQuery).then(function (value: InsightResponse) {
            console.log(value.code, value.body);
            expect(value.code).to.equal(200);
            // TODO: it MUST be this exact format based on d3 page
            expect(value.body).to.deep.equal({"render":"TABLE","result":[{"rooms_furniture":"Classroom-Fixed Tables/Fixed Chairs"},{"rooms_furniture":"Classroom-Fixed Tables/Movable Chairs"},{"rooms_furniture":"Classroom-Fixed Tables/Moveable Chairs"},{"rooms_furniture":"Classroom-Fixed Tablets"},{"rooms_furniture":"Classroom-Hybrid Furniture"},{"rooms_furniture":"Classroom-Learn Lab"},{"rooms_furniture":"Classroom-Movable Tables & Chairs"},{"rooms_furniture":"Classroom-Movable Tablets"},{"rooms_furniture":"Classroom-Moveable Tables & Chairs"},{"rooms_furniture":"Classroom-Moveable Tablets"}]});
            done();
        }).catch(function (err) {
            console.log(err.code, err.body);
    ...
    it("Rooms: test remove valid zip that is added, ResponseCode 204", function (done) {
        insightFacade.removeDataset("rooms").then(function (value: InsightResponse) {
            console.log(value.code, value.body);
            sanityCheck(value);
            expect(value.code).to.equal(204);
            done();
